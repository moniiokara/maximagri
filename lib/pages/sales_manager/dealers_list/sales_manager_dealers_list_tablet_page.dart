...
class SalesManagerDealersListTabletPage extends StatefulWidget {
  const SalesManagerDealersListTabletPage({Key? key}) : super(key: key);

  @override
  State<SalesManagerDealersListTabletPage> createState() =>
      _SalesManagerDealersListTabletPageState();
}

class _SalesManagerDealersListTabletPageState
    extends State<SalesManagerDealersListTabletPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('SalesManagerDealersListTabletPage'),
      ),
