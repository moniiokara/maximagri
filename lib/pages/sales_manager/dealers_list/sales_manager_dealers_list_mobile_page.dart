...
class SalesManagerDealersListMobilePage extends StatefulWidget {
  const SalesManagerDealersListMobilePage({Key? key}) : super(key: key);

  @override
  State<SalesManagerDealersListMobilePage> createState() =>
      _SalesManagerDealersListMobilePageState();
}

class _SalesManagerDealersListMobilePageState
    extends State<SalesManagerDealersListMobilePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('SalesManagerDealersListMobilePage'),
      ),
