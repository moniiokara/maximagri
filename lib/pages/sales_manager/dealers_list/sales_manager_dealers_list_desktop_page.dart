...
class SalesManagerDealersListDesktopPage extends StatefulWidget {
  const SalesManagerDealersListDesktopPage({Key? key}) : super(key: key);

  @override
  State<SalesManagerDealersListDesktopPage> createState() =>
      _SalesManagerDealersListDesktopPageState();
}

class _SalesManagerDealersListDesktopPageState
    extends State<SalesManagerDealersListDesktopPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('SalesManagerDealersListDesktopPage'),
      ),
      body: Row(
        children: [
          SalesManagerDrawer(),
