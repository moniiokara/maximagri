...
class OperationsDashboardTabletPage extends StatefulWidget {
  const OperationsDashboardTabletPage({Key? key}) : super(key: key);

  @override
  State<OperationsDashboardTabletPage> createState() =>
      _OperationsDashboardTabletPageState();
}

class _OperationsDashboardTabletPageState
    extends State<OperationsDashboardTabletPage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('OperationsDashboardTabletPage'),
      ),
