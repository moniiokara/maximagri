...
class OperationsZonalManagerListTabletPage extends StatefulWidget {
  const OperationsZonalManagerListTabletPage({Key? key}) : super(key: key);

  @override
  State<OperationsZonalManagerListTabletPage> createState() =>
      _OperationsZonalManagerListTabletPageState();
}

class _OperationsZonalManagerListTabletPageState
    extends State<OperationsZonalManagerListTabletPage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('OperationsZonalManagerListTabletPage'),
      ),
