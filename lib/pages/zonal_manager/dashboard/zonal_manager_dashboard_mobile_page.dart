...
class ZonalManagerDashboardMobilePage extends StatefulWidget {
  const ZonalManagerDashboardMobilePage({Key? key}) : super(key: key);

  @override
  State<ZonalManagerDashboardMobilePage> createState() =>
      _ZonalManagerDashboardMobilePageState();
}

class _ZonalManagerDashboardMobilePageState
    extends State<ZonalManagerDashboardMobilePage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('ZonalManagerDashboardMobilePage'),
      ),
